...
///
/// SwiftPM/xtool variant of the controller the Xcode project (ios/Example)
/// carries: same streaming scheme handler, native plugin registry and
/// WebSocket bridge wiring, plus the dev-mode support `irgo app run ios
/// --dev` relies on (IRGO_DEV_SERVER in Info.plist).
